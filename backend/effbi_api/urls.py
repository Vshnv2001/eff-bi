...
urlpatterns = [
    ...
    path("user-access-permissions/<str:user_id>/", views.get_user_access_permissions, name="get_user_access_permissions"),
    path("user-access-permissions/", views.add_user_access_permissions, name="add_user_access_permissions")
]
