...
const databases = [
  ...
  { id: "postgresql", name: "PostgreSQL", logo: "https://www.vectorlogo.zone/logos/postgresql/postgresql-ar21.svg" },
  { id: "sqlite", name: "SQLite", logo: "https://www.vectorlogo.zone/logos/sqlite/sqlite-ar21.svg" },
  { id: "oracle", name: "Oracle DB", logo: "https://www.vectorlogo.zone/logos/oracle/oracle-ar21.svg" },
];
    ...
    <ThemeProvider value={darkTheme}>
      <div className="min-h-screen bg-gray-900 text-gray-100 p-8">
        <div className="max-w-4xl mx-auto">
          <Typography as="h2" color="white" className="mb-6 text-3xl font-bold text-center">
          ...
          <div className="mt-10">
            <Typography as="h3" color="white" className="mb-2 text-xl font-bold">
              Enter Database URI
            </Typography>
            <input
              type="text"
