...
export default function Page(): React.JSX.Element {
  ...
  const radarChartMultipleSeriesData = [
    {
      name: "Series 1",
      data: [80, 50, 30, 40, 100, 20],
    },
  ...
  const radarChartMultipleCategoriesData = [
    "2011",
    "2012",
    "2013",
    "2014",
  ...
  const radarPolarSeriesData = [14, 23, 21, 17, 15, 10, 12, 17, 21];

  // Mock data for Scatter Chart
  const scatterChartSeriesData: {
    name: string;
    data: [number, number][];
  }[] = [
    {
  ...
  const timeSeriesDates = [
    { x: new Date("2022-01-01"), y: 5000000 },
    { x: new Date("2022-02-01"), y: 7000000 },
    { x: new Date("2022-03-01"), y: 8000000 },
    { x: new Date("2022-04-01"), y: 6500000 },
    { x: new Date("2022-05-01"), y: 9000000 },
    { x: new Date("2022-06-01"), y: 9500000 },
  ];
