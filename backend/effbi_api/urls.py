...
urlpatterns = [
    ...
    path("dashboard-tiles/<int:id>/", views.get_dashboard_tile, name="get_dashboard_tile"),
    path("dashboard-tiles-delete/<int:id>/", views.delete_dashboard_tile, name="delete_dashboard_tile"),
    ...
    #path("stream/", views.generate_stream, name="streaming"),
]
